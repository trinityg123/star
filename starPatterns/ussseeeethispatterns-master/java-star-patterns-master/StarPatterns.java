...
class StarPatterns 
{
    ...
    public static void biggerCheckerBoard(int h, int l,int segment){
        for(int i=0; i<h; i++){
            for(int x=0; x<h+2; x++){
                if ((x+i)%3==2 || (x+i)%3==1){
                    System.out.print("*");
    ...
    public static void upsideDownCheckeredTriangle(int len){
        int h = len*2;
        for(int i=0; i<len; i++){
            for(int x=0; x<h; x++){
                if((x+i == 10) || x==i || (x+i)%2==0 && x>i && x+i <=10){
                    System.out.print("*");
                }
                else{
                    System.out.print(" ");
    ...
    public static void primeStars(int h, int len){
        for(int i=0; i<h; i++){
            for(int x=0; x<len; x++){
                
                if(x==0 || x==1 || (x+i)%3==0 && i>0 && x <2){
                    System.out.print("*");
                }
                else{
                    System.out.print(" ");
